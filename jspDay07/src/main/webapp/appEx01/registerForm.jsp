...
<legend>회원가입</legend>
	<form action="registerOk.jsp" method="post">
		...
		<input type="text" name="nickName" required placeholder="별명"><br>
		<input type="password" name="pwd" required placeholder="비밀번호"><br>
		<input type="email" name="email" required placeholder="이메일"><br>
		<input type="text" name="tel" required placeholder="전화번호"><br>
